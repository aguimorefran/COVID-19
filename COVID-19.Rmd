...
camas_habitantes <- camas_habitantes %>% 
  mutate(privados_100000 = format(round((privados/total_habitantes)*100000, 4), nsmall=4)) %>% 
  mutate(publicos_100000 = format(round((públicos/total_habitantes)*100000, 4), nsmall=4)) %>% 
  mutate(total_camas_100000 = format(round((total_camas/total_habitantes)*100000, 4), nsmall=4))
```
