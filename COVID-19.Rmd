...
plot(head(reglas, 20), method="graph", engine="graphviz")

# reglas que tengan como rhs solo pocas camas publicas
...
reglas_sanidad_camas <- subset(reglas, lhs %in% "camas_publicas_10000s0=bajo") %>%
