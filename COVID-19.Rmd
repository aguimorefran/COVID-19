...
densidad_pob <- read_delim("datasets/ccaa_densidad_pob.csv", 
    ";", escape_double = FALSE, trim_ws = TRUE)
densidad_pob$total <- as.numeric(gsub(".", "", densidad_pob$total, fixed = TRUE))
densidad_pob <- densidad_pob %>% select(cod_ine, CCAA, total)
head(densidad_pob)
```
