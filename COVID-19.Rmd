...
WDICountry <- read_csv("WDI Datasets/WDICountry.csv")[, c(2, 9)]
...
rules <- apriori(merged, parameter = list(support = 0.01, confidence = 0.5, minlen = 2), appearance = list(lhs=c("income=low", "income=medium", "income=high")))
