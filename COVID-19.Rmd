...
casos_hospi_ccaa <- casos_hospi_ccaa%>% 
  mutate(nuevos_hospi = c(NA, diff(total)))

# junto para plot uci y hospi nuevos
casos_hospi_ccaa <- merge(casos_hospi_ccaa, casos_uci_ccaa, by = c("fecha", "cod_ine")) %>% 
...
```{r}
# JUNTAR EN UN DATAFRAME PARA APLICAR REGRESION Y ARULES
# casos hospi
# casos uci diarios
# casos infectaos
...
## Relación entre la riqueza media de los países y los fallecidos y recuperados que tienen por cada infectado.
