...
```{r}
g1 <- glmulti(names(super_reg[1]), names(super_reg[-1]), data = super_reg, level = 1, plotty = F, report = F)
g2 <- glmulti(names(super_reg[1]), names(super_reg[-1]), data = super_reg, method = "d")

summary(g1)$bestmodel
summary(g2)$bestmodel
```
