...
camas_habitantes %>% 
  ...
  facet_wrap(~ ccaa) + 
  labs(title = "Camas UCI por cada 100,000 habitantes",subtitle = "Clasificados por Comunidad Autónoma y si pertenecen a un centro privado o público", caption = "Datos proporcionados por datadista") + 
