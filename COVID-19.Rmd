...
# hago regresion por cada ccaa de casos ~ e^(a*dias)
modelos <- casos_ccaa_nuevos_creciente %>% 
  group_by(ccaa) %>%
  summarise(mod = list(nls(nuevos ~ I(exp(dias_caso0*a) + b) )))
...
# estimador de como de rapido crece una funcion teniendo en cuenta la poblacion
