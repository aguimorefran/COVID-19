...
covidRA <- covid %>%
  select(age, sex, country, province, date_onset_symptoms, date_admission_hospital, date_confirmation, stayed_wuhan, reported_market_exposure, chronic_disease_binary, date_death_or_discharge)
...
* `time_symptom_deth`: tiempo desde que se observan síntomas hasta que muere.
```{r time symptom death}
```
