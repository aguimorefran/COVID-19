...
* **Datos demográficos (muy incompleto)**: https://www.kaggle.com/sudalairajkumar/novel-corona-virus-2019-dataset/data#COVID19_open_line_list.csv, (actualizado hasta el día 20/03/2020). 
...
* **Infectados, muertos y recuperados globálmente**:
https://github.com/CSSEGISandData/COVID-19

```{r,  message = FALSE, warning = FALSE}
# DESCARGADO EL 6 DE ABRIL
...
```{r pais hist, echo = FALSE, warning = FALSE, message = FALSE, fig.align="center"}
# hacemos un cumsum de todos los confirmados globalmente
conf <- cc %>%
